...
void StokeSys::addCollisionForce(int iblk, int jblk, double DIST_EPS)
{
	...
	for (int p = 0; p < displs[mpi_size]; p++) {
	    ...
	    double f = 5.0*CldForceMag(cld.dist/DIST_EPS);
