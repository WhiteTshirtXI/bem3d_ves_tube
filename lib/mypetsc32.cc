...
void myVecScatter(VecScatter scatter, Vec x, double *py, InsertMode addv, ScatterMode mode)
{
    ...
    VecGetSize(x, &nrow);
    VecCreateSeqWithArray(PETSC_COMM_SELF, nrow, py, &y);
...
void myMatMult(Mat A, double *x, double *y)
{
    ...
    Vec x_vec, y_vec;
    VecCreateSeqWithArray(PETSC_COMM_SELF, nrow, y, &y_vec);
    VecCreateSeqWithArray(PETSC_COMM_SELF, ncol, x, &x_vec);
...
void myMatMultAdd(double alpha, Mat A, double *x, double *y)
{
    ...
    Vec x_vec, tmp_vec;
    VecCreateSeqWithArray(PETSC_COMM_SELF, nrow, tmp, &tmp_vec);
    VecCreateSeqWithArray(PETSC_COMM_SELF, ncol, x, &x_vec);
